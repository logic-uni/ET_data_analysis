...
select_neuron_path = rf'C:\Users\zyh20\Desktop\Research\01_ET_data_analysis\Research\ISI_distribution\{sorting_method}' 
...
def main(units):
    ...
    region_neurons = units.groupby('region')['neuron_id'].apply(list).to_dict()
...
main(neurons)
#save_selected_neuron_spike_times(5)